                ...
                Promise.all(promises).then(function() {
                    for(var key in model._joins) {
                        if (((model._joins[key].model.getName() in modelToSave) || (saveAll === true)) &&
                            ...
                            self[key].__proto__._belongLinks[model.getName()] = {
                                doc: self,
...
Document.prototype.delete = function() {
    ...
    // doc.otherDoc.delete()
    // otherDoc.__proto__._belongLinks[self._getModel()]
    for(var key in self.__proto__._belongLinks) {
        delete self.__proto__._belongLinks[key].doc[self.__proto__._belongLinks[key].key];
        delete self.__proto__._belongLinks[key].doc[self.__proto__._belongLinks[key].foreignKey];
        promises.push(self.__proto__._belongLinks[key].doc.save());
    }
