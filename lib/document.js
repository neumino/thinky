...
Document.prototype._saveSelf = function(
  ...
  var buildQuery = function () {
    if (self.__proto__._saved === false) {
      ...
      //         console.log('Upgrading ' + constructor.getTableName() + ' version from', existingVersion, 'to', newVersion);
      //         copy[model._version] = newVersion;
      //         return r.branch(row(model._version).eq(existingVersion), copy, r.error("Versioning failed - there is a different version in the database from " + existingVersion));
