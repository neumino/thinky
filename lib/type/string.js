...
function TypeString() {
  ...
  /**
   * Whether this string may not be empty.
   * @type {boolean}
   */
  this._noEmpty = false;
  /**
...
/**
 * Set the string to not allow empty string
 * @return {TypeString}
 */
TypeString.prototype.noEmpty = function() {
  this._noEmpty = true;
  return this;
}
...
TypeString.prototype.validate = function(str, prefix, options) {
  ...
  if ((typeof str === 'function') && (str._query !== undefined)) {
    ...
    if ((this._noEmpty !== -1) && (str === "")) {
      throw new Errors.ValidationError("Value for "+prefix+" may not be empty.")
    }
