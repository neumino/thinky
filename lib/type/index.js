...
var TypeAny = require('./any'),
    TypeArray = require('./array'),
    TypeBoolean = require('./boolean'),
    TypeBuffer = require('./buffer'),
    TypeDate = require('./date'),
    TypeNumber = require('./number'),
    TypeObject = require('./object'),
    TypePoint = require('./point'),
    TypeString = require('./string'),
    TypeVirtual = require('./virtual');
