...
var fillDefault = require(__dirname+'/defaultValue.js');
...
Model.new = function(name, schema, options, thinky) {
    ...
    proto.__doc_validator = validator(name, schema);
    proto.__fillDefault = fillDefault(name, schema, false);
    proto.__fillVirtual = fillDefault(name, schema, true);
