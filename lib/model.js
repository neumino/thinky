...
Model.prototype._indexWasCreated = function(type) {
    console.log('index created', type, this.getName(), this._getModel()._indexesToCreate, this._getModel()._foreignIndexesToCreate)
    if (type === 'local') {
...
Model.prototype._tableWasCreated = function() {
    ...
    if (self._getModel()._onTableCreated.length > 0) {
        console.log('Length ontablecreated', self._getModel()._onTableCreated.length)
        // Create indexes, 
