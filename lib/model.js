...
function Model(name, schema, options, thinky) {
  ...
  this._options.optimisticLocking = (options.optimisticLocking != null) ? options.optimisticLocking : thinky._options.optimisticLocking;
  ...
  this._version = this._options.optimisticLocking ? this._options.optimisticLocking : undefined;
