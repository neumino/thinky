...
function Model(name, schema, options, thinky) {
    ...
    //TODO We don't use it now, do we still need that?
    this._reverseJoins = {};
}
    ...
    if (options.init !== false) {
        ...
        var query = r.branch( // Create link
            ...
            r.tableCreate(link).do(function() {
                // This takes about one second to execute and is a dirty patch for https://github.com/rethinkdb/rethinkdb/issues/2226
