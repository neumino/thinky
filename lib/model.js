...
Model.prototype._indexCreated = function() {
    model._getModel()._indexesToCreate--;
    if ((model._getModel()._tableCreated === true) && (model._getModel()._indexesToCreate === 0)) {
...
Model.prototype.hasOne = function(joinedModel, fieldDoc, leftKey, rightKey, options) {
    ...
    if (options.noIndex !== true) {
        ...
        var tableName = joinedModel._getModel()._name;
        ...
        if (model._getModel()._tableCreated === true) {
            ...
            this._getModel()._onTableCreated.push({
                //TODO
            })
        }
    }
