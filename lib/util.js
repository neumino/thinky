...
function mergeOptions(options, newOptions) {
  if (util.isPlainObject(newOptions)) {
    ...
    localOptions.enforce_missing =
      (exists(newOptions.enforce_missing)) ? newOptions.enforce_missing : options.enforce_missing;
    localOptions.enforce_type =
      (exists(newOptions.enforce_type)) ? newOptions.enforce_type : options.enforce_type;
    localOptions.enforce_extra =
      (exists(newOptions.enforce_extra)) ? newOptions.enforce_extra : options.enforce_extra;
    return localOptions;
  }
