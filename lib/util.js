            ...
            if (Array.isArray(schema[key])) {
                ...
                if (schema[key].hasOwnProperty('_type')) {
                    if ((schema[key]._type !== String)
                        ...
                        throw new Error("The field `_type` must be `String`/`Number`/`Boolean`/`Date`/`Buffer`/`Object`/`Array`/`'virtual'` for "+prefix+"["+key+"]");
                    }
                ...
                throw new Error("The value must be `String`/`Number`/`Boolean`/`Date`/`Buffer`/`Object`/`Array`/`'virtual'` for "+prefix+"["+key+"]");
            }
        }
    }
